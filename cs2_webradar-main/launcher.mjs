...
const aiExe = join(aiDir, "cs2_ai.exe");
const aiOffsets = join(aiDir, "Configuration", "offsets.json");
...
console.log("CS2 AI is disabled by default. Press 9 to toggle it.");
