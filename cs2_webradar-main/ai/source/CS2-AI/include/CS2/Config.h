...
struct Config 
{
	...
	int delay_between_shots = 10;
	bool ignore_same_team = true;
	bool visible_targets_only = true;
	float aim_fov_degrees = 24.0f;
	float aim_smoothing = 0.88f;
	float aim_max_step_degrees = 14.0f;
	...
	float trigger_head_tolerance_degrees = 0.06f;
	float recoil_compensation = 1.50f;
