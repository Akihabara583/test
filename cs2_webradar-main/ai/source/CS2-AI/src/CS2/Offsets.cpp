...
std::optional<Offsets> load_offsets_from_files()
{
	...
	try
	{
		...
		offsets.highest_entity_index = static_cast<uintptr_t>(general_offsets_json["client.dll"]["dwGameEntitySystem_highestEntityIndex"]);
		...
		offsets.view_offset = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_BaseModelEntity"]["fields"]["m_vecViewOffset"]);
		offsets.velocity = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_BaseEntity"]["fields"]["m_vecVelocity"]);
		offsets.flags = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_BaseEntity"]["fields"]["m_fFlags"]);
		offsets.model_state = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CSkeletonInstance"]["fields"]["m_modelState"]);
		offsets.entity_spotted_state = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_CSPlayerPawn"]["fields"]["m_entitySpottedState"]);
		offsets.spotted_by_mask = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["EntitySpottedState_t"]["fields"]["m_bSpottedByMask"]);
		offsets.aim_punch_services = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_CSPlayerPawn"]["fields"]["m_pAimPunchServices"]);
		offsets.aim_punch_angle = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CCSPlayer_AimPunchServices"]["fields"]["m_unpredictableBaseAngle"]);
		offsets.predictable_aim_punch_angle = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CCSPlayer_AimPunchServices"]["fields"]["m_predictableBaseAngle"]);
		offsets.camera_services = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_BasePlayerPawn"]["fields"]["m_pCameraServices"]);
		offsets.view_punch_angle = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CPlayer_CameraServices"]["fields"]["m_vecCsViewPunchAngle"]);
		offsets.entity_identity = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CEntityInstance"]["fields"]["m_pEntity"]);
		offsets.entity_designer_name = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["CEntityIdentity"]["fields"]["m_designerName"]);
		offsets.smoke_did_effect = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_SmokeGrenadeProjectile"]["fields"]["m_bDidSmokeEffect"]);
		offsets.smoke_detonation_position = static_cast<uintptr_t>(client_offsets_json["client.dll"]["classes"]["C_SmokeGrenadeProjectile"]["fields"]["m_vSmokeDetonationPos"]);
