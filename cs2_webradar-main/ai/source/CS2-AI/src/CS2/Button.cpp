...
void Button::update()
{
	SHORT key_state = GetAsyncKeyState(m_button);
...
bool Button::is_key_down(SHORT key_state) const
{
	static constexpr SHORT most_significant_bit = static_cast<SHORT>(0x8000);
